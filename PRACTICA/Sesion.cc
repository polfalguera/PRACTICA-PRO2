...
void Sesion::modificar_enviables_s(Problemas& enviables, Problemas& resueltos) const
{
    i_modificar_enviables_s(problemas_sesion,enviables,resueltos);
}

void Sesion::i_modificar_enviables_s(const BinTree<int>& problemas_sesion, Problemas& enviables, Problemas& resueltos) const
{
...
void Sesion::modificar_enviables_envio(const string& p, bool& encontrado, Problemas& enviables, Problemas& resueltos) const
{
    i_modificar_enviables_envio(problemas_sesion,p,encontrado,enviables,resueltos);
}

void Sesion::i_modificar_enviables_envio(const BinTree<int>& problemas_sesion, const string& p, bool& encontrado, Problemas& enviables, Problemas& resueltos) const
{
    if (not problemas_sesion.empty()) 
    {
